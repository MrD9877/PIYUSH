...
export const UserSchema = z.object({
  ...
  name: z.string().min(3, { message: "Name is too short." }).max(20, { message: "Name is too long." }),
  message: z.string().min(10, { message: "Message is to short." }).max(2000, { message: "Please send reasonable size message." }),
});
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="h-fit py-[6vh]  invisible bg-[linear-gradient(0deg,_#393632,_#080807)] w-[89vw] mx-auto rounded-lg sticky  contact-card -translate-y-14 font-popins text-silverMain">
      <h2 style={{ fontWeight: 700 }} className=" w-fit mx-auto text-[10vw] lg:text-[7vw] text-center  scrambleLoop-animation" data-secondtext="CONTACT ME TODAY!!" data-text="LET' MAKE IT HAPPEN">
        LET&apos; MAKE IT HAPPEN
      </h2>

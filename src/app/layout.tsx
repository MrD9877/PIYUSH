...
export const metadata: Metadata = {
  title: "Piyush Tuteja -Data & Business Analyst (Consulting)",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        style={{ fontWeight: 500, lineHeight: 1, letterSpacing: "-0.025rem" }}
        className={`${geistSans.variable} ${geistMono.variable} antialiased ${popins.variable} ${anonymous.variable}`}
      >
        <>
          <div>
            <Curtain />
